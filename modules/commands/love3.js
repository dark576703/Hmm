...
module.exports.onLoad = async() => {
    ...
    const path = resolve(__dirname, 'cache/canvas', 'love3.jpg');
...
async function makeImage({ one, two }) {
    ...
    let tromcho_img = await jimp.read(__root + "/love3.jpg");
    ...
    tromcho_img.composite(circleOne.resize(270, 263), 677, 171).composite(circleTwo.resize(227, 280), 1100, 92);
