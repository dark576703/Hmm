...
const res1 = await axios.get(`https://rndapi--imranapiv2.repl.co/ai`);
const res2 = await axios.get(`https://rndapi--imranapiv2.repl.co/ai`);
const res3 = await axios.get(`https://rndapi--imranapiv2.repl.co/ai`);
const res4 = await axios.get(`https://rndapi--imranapiv2.repl.co/ai`);
const res5 = await axios.get(`https://rndapi--imranapiv2.repl.co/ai`);
const res6 = await axios.get(`https://rndapi--imranapiv2.repl.co/ai`);
